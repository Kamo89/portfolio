...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Kamohelo Mosiya" },
      { property: "og:site_name", content: "SitesByKamo" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          name: "SitesByKamo",
          description:
            "Modern websites, ecommerce experiences and digital products for businesses, brands and entrepreneurs.",
          founder: { "@type": "Person", name: "Kamohelo Mosiya" },
